...
//is seated in a contiguous circuit all the way around the sport field, and so the wave is able
...
//any given time in an arena, although simultaneous, counter-rotating waves have been produced.
//(Source Wikipedia)
...
//Создать пустой финальный массив в который буду добавлять елементы
//Пройтись по массиву, Если елемент не пустая строка - переводим елемент в верхний реестр
//Записываем обьедененный массив(строку) в финальный массив.
//Проводим елемент назад в нижний реестр для след прохождения по циклу
//Добавить ПРОВЕРОК!!!!
